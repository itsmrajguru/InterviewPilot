        ...
        <div className="ip-auth-box" style={{ background: "var(--color-bg-panel)",
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <label style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "var(--text-secondary)" }}>Identity</label>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 4, padding: 4, borderRadius: "var(--radius-md)", background: "var(--color-bg-panel-sunken)" }}>
                <button
                  type="button"
                  onClick={() => setRole("student")}
                  style={{
                    padding: "8px 0", borderRadius: 6, fontSize: 11, fontWeight: 700, border: "none", cursor: "pointer", transition: "all 0.15s",
                    background: role === "student" ? "var(--color-bg-panel)" : "transparent",
                ...
                <button
                  ...
                  style={{
                    padding: "8px 0", borderRadius: 6, fontSize: 11, fontWeight: 700, border: "none", cursor: "pointer", transition: "all 0.15s",
                    background: role === "company" ? "var(--color-bg-panel)" : "transparent",
                    color: role === "company" ? "var(--text-primary)" : "var(--text-secondary)",
                    boxShadow: role === "company" ? "var(--shadow-sm)" : "none"
                  }}
                >
                  Employer
                </button>
