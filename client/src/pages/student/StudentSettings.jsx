    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "#e4e8ee", fontFamily: "var(--font-sans)", fontSize: 14 }}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <main style={{ flex: 1, padding: "28px 32px", overflowY: "auto" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: 12, border: "1px solid #dde1e8", boxShadow: "0 1px 4px rgba(0,0,0,0.07)", padding: 32, maxWidth: 600 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 0", borderBottom: "1px solid #f1f4f7" }}>
                  ...
                  <button onClick={() => setNotifications(!notifications)} style={{ width: 44, height: 24, borderRadius: 12, background: notifications ? "#111827" : "#e5e7eb", border: "none", position: "relative", cursor: "pointer", transition: "all 0.2s" }}>
                    <div style={{ width: 20, height: 20, borderRadius: "50%", background: "#ffffff", position: "absolute", top: 2, left: notifications ? 22 : 2, transition: "all 0.2s" }} />
                  </button>
                </div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 0" }}>
                  ...
                  <button onClick={() => setDarkMode(!darkMode)} style={{ width: 44, height: 24, borderRadius: 12, background: darkMode ? "#111827" : "#e5e7eb", border: "none", position: "relative", cursor: "pointer", transition: "all 0.2s" }}>
                    <div style={{ width: 20, height: 20, borderRadius: "50%", background: "#ffffff", position: "absolute", top: 2, left: darkMode ? 22 : 2, transition: "all 0.2s" }} />
                  </button>
                </div>
              </div>
              <div>
                <h2 style={{ fontSize: 16, fontWeight: 600, color: "var(--text-primary)", margin: "0 0 16px 0" }}>Security</h2>
                <button style={{ background: "#ffffff", border: "1px solid #dde1e8", padding: "10px 16px", borderRadius: 8, fontSize: 13, fontWeight: 600, color: "#111827", cursor: "pointer" }}>Change Password</button>
              </div>
              <div>
