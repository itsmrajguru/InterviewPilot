  ...
  return (
    <div style={{
      ...
      {items.map(({ label, value, sub }) => (
        <div key={label} style={{ background: "#ffffff", border: "0.5px solid #dde1e8", borderRadius: 12, padding: "18px 20px", boxShadow: "0 1px 4px rgba(0,0,0,0.07)" }}>
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "#111827", color: "#ffffff", whiteSpace: "nowrap"
                  }}
                >
                ...
                <div style={{ display: "flex", gap: 32, alignItems: "flex-start", flexWrap: "wrap" }}>
                  ...
                  <div style={{ flex: "1 1 400px", minWidth: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
                      <div style={{ width: 8, height: 8, borderRadius: "50%", background: pendingSessions.length > 0 ? "var(--color-primary-500)" : "var(--text-muted)", boxShadow: pendingSessions.length > 0 ? "0 0 0 3px var(--color-primary-100)" : "none" }}/>
                    ...
                    {pendingSessions.length === 0 ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        {pendingSessions.map((session, idx) => (
                          <div key={session._id} className="ticket-card sr-fade-up" style={{ animationDelay: `${idx * 0.05}s`, display: "flex", background: "#ffffff", borderRadius: 12, border: "1px solid #dde1e8", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", overflow: "hidden" }}>
                            
                            <div style={{ flex: 1, padding: "20px 24px", position: "relative" }}>
                              <div style={{ position: "absolute", top: 0, left: 0, width: 4, height: "100%", background: "var(--color-primary-400)" }}/>
                            ...
                            <div style={{ width: 140, borderLeft: "2px dashed #e2e8f0", background: "#f8fafc", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10 }}>
                    ...
                    {completedSessions.length === 0 ? (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        {completedSessions.map((session, idx) => {
                          ...
                          return (
                            <div key={session._id} className="list-row sr-fade-up" style={{ animationDelay: `${idx * 0.05}s`, display: "flex", alignItems: "center", padding: "16px 20px", background: "#ffffff", borderRadius: 12, border: "1px solid #dde1e8", gap: 16 }}>
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  fontWeight: 600, border: "1px solid #e2e8f0", background: "transparent",
