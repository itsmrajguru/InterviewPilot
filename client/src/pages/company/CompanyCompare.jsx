          ...
          {loading ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              {candidate1 || candidate2 ? (
                    ...
                    {candidate1 ? (
                      <>
                        ...
                        <button
                          ...
                          style={{ fontSize: 12, color: "#ffffff", background: "var(--accent)", border: "none", borderRadius: 8, padding: "10px 16px", cursor: "pointer", fontWeight: 500, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, width: "100%", marginTop: 12 }}
                        >
                ...
                <div style={{ background: "var(--bg-card)", border: "0.5px solid var(--border)", borderRadius: 12, boxShadow: "0 1px 4px rgba(0,0,0,0.07)", padding: 48, textAlign: "center", fontSize: 12, color: "var(--text-muted)" }}>
